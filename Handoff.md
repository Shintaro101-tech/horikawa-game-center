...
- 🟡 Batch 4（4体）: サイボーグ忍者 / 侍大将 / 雷神 / ミサイル戦車 — **プレビュー作成済、選択待ち**

### 残り（12/27 未着手）
- 🟡 **Batch 4: 中後半4体** — `cyber_ninja`（サイボーグ忍者）/ `taisho`（侍大将）/ `raijin`（雷神）/ `missile_tank`（ミサイル戦車）— プレビュー作成済、ユーザの選択待ち
